...
//extension UITabBarController: SafeType {
//    
...
//    }
//
//    func updateTabBarItem(at index: Int, title: String?, image: UIImage?, selectedImage: UIImage?) {
...
//    }
//    
//    // 修改指定 TabBarItem 的位置和大小
//    func modifyTabBarItem(at index: Int, width: CGFloat, height: CGFloat, leftMargin: CGFloat, rightMargin: CGFloat, bottomMargin: CGFloat) {
//        hasSafeCollection(index: index, items: self.tabBar.items ?? []) { tabBarItem in
//
